...
INSERT INTO Orders(order_status, order_amount, number_of_products, order_date, email_id, product_id) VALUES
    ('Shipped', 200.00, 2, '2019-08-13', 'abc98@gmail.com', 1),
...
INSERT INTO Shipping_Address(area, city, state, country, email_id) VALUES 
    ('plot no. 605', 'jaipur', 'rajasthan', 'india', 'abc98@gmail.com'),
    ('MBM HOSTEL', 'JODHPUR', 'rajasthan', 'india', 'rs98@gmail.com'),
    ('JUHU BEACH', 'GOA', 'GOA', 'india', 'rs98@gmail.com'),
    ('NEAR GANESH MANDIR', 'jaipur', 'rajasthan', 'india', 'def@gmail.com'),
    ('HALDI GHATI MARG', 'jaipur', 'rajasthan', 'india', 'def@gmail.com'),
    ('UDAPURIA', 'UDAIPUR', 'rajasthan', 'india', 'abc98@gmail.com'),
    ('RAM MARG', 'JAISALMAIR', 'rajasthan', 'india', 'pqr@gmail.com'),
    ('RANA SANGA MARG', 'HALDI GHATI', 'PRATAP NAGAR', 'india', 'xyz@gmail.com'),
    ('BAPU NAGAR', 'JAIPUR', 'rajasthan', 'india', 'abc98@gmail.com');
