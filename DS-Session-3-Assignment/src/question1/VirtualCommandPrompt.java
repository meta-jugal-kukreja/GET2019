...
/**
 * This class denotes the Virtual Command Prompt
 * @author Jugal
 * Dated 08/04/2019
 */
public class VirtualCommandPrompt {
	...
	/**
     * This method implements the virtual command prompt
     */
    public void virtualCommandPrompt() {
        ...
        while (true) {
            ...
            // command to list all the sub-folders in the current directory
            case "ls":
                for (Directory subDirectory : currentDirectory.getListOfSubDirectory()) {
            ...
            // command to find the path of the existing directory
            case "find":
                if (commandWords.length >= 2) {
    ...
    /**
     * This method displays the complete directory structure recursively
     * @param currentDirectory is the current directory(root directory)
     * @param nesting is the level of the sub-folder
     */
    void printTree(Directory currentDirectory, int nesting) {
        for (Directory subDirectory : currentDirectory.getListOfSubDirectory()) {
    ...
    /**
     * This method finds the path of the given directory
     * @param currentDirectory is the current directory
     * @param directoryToBeSearched is the directory to be searched
     * @param relativePath is the relative path
     * @return {List<String>} list of path of the folder
     */
    List<String> find(Directory currentDirectory, String directoryToBeSearched, String relativePath) {
        List<String> paths = new ArrayList<String>();
        for (Directory subDirectory : currentDirectory.getListOfSubDirectory()) {
