...
/**
 * This class class calculates the molecular mass of the compound using a stack and some other member functions.
 * Assumption : The symbols(Atoms) in the organic compound will only be C, O, H.
 * @author Jugal
 * Dated 08/02/2019
 */
