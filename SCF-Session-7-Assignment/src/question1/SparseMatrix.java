...
public class SparseMatrix {
	 ...
	 * @param inputMatrix is the matrix whose multiplication is to be carried out with the current matrix
	...
	/**
	 * This method checks whether the given row and column index are present in the matrix
