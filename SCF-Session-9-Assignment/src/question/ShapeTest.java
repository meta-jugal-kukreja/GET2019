...
/**
 * This class contains methods to test the methods of Screen class
 * @author Jugal
 * Dated 07/24/2019
 */
public class ShapeTest {
	...
	public void testAddDelete()
	{
		...
		//@param {X coordinate of origin, Y coordinate, length of the rectangle, width}
		...
		double tParams[] = new double[] {2, 3, 10, 50};
